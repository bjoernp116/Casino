...
while True:
    ...
    def rbp():
        ...
        bet = input("What would you like to bet on? ")
...
#colour
        if pick in black and (bet == 'black')  :
            print('You win! Here is your win $' , win_2to1)
            time.sleep(1)
            print('Your total is : $' , (int(money) + win_2to1))
            money = (int(money) + win_2to1)

        elif pick in red and (bet == 'red') :
            print('You win! Here is your win $' , win_2to1)
            time.sleep(1)
            print('Your total is : $' , (int(money) + win_2to1))
            money = (int(money) + win_2to1)
    #high low
        elif pick in high and (bet == 'high') :
            print('You win! Here is your win $' , win_2to1)
            time.sleep(1)
            print('Your total is : $' , (int(money) + win_2to1))
            money = (int(money) + win_2to1)

        elif pick in low and (bet == 'low') :
            print('You win! Here is your win $' , win_2to1)
            time.sleep(1)
            print('Your total is : $' , (int(money) + win_2to1))
            money = (int(money) + win_2to1)
    #even odd
        elif pick in odd and (bet == 'odd') :
            print('You win! Here is your win $' , win_2to1)
            time.sleep(1)
            print('Your total is : $' , (int(money) + win_2to1))
            money = (int(money) + win_2to1)

        elif pick in even and (bet == 'even') :
            print('You win! Here is your win $' , win_2to1)
            time.sleep(1)
            print('Your total is : $' , (int(money) + win_2to1))
            money = (int(money) + win_2to1)
